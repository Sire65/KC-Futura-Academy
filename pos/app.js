...
const DEFAULT_PRODUCTS=[
 ...
 {id:"apfel",name:"Apfelpunsch",price:4.50,category:"Getränke",image:"assets/apfelpunsch_auth.webp",depositComponents:[{id:"glass",name:"Glaspfand",price:2}]},
 {id:"roterfeger",name:"Roter Feger",price:2.50,category:"Getränke",image:"assets/roter_feger.webp",color:"#b3202a",info:{status:"approved",shortDescription:"Alkoholfreier roter Kirschpunsch",ingredients:"Kirschsaft, Gewürze, Zucker",additives:"Keine Angaben",important:"Alkoholfrei - auch für Kinder geeignet.",source:"Vereinsangabe"},depositComponents:[{id:"glass",name:"Glaspfand",price:2}]},
 {id:"eier",name:"Eierlikörpunsch",price:6.50,category:"Getränke",image:"assets/eierlikoerpunsch_auth.webp",depositComponents:[{id:"glass",name:"Glaspfand",price:2}]},
 ...
 {id:"knirpse",name:"Kartoffelknirpse",price:4.00,category:"Speisen",active:false,image:"assets/sauerkraut_auth.webp",color:"#a66e24",info:{ingredients:"Kartoffeln, Öl, Gewürze",allergens:"Dips können Milch und Milchprodukte enthalten",important:"Dip-Auswahl: Kartoffeldip, Tzatziki oder ohne Dip."},optionGroup:"dip"},
 {id:"knirpseher",name:"Knirpse mit Heringsstipp",price:4.50,category:"Speisen",active:false,image:"assets/sauerkraut_auth.webp",color:"#a66e24",info:{ingredients:"Kartoffeln, \u00d6l, Gew\u00fcrze, Heringsstipp",allergens:"Enth\u00e4lt Fisch; Stipp kann Milch und Milchprodukte enthalten"}},
...
{const patches={mettwurst:{image:"assets/mettwurst_auth.webp"},hering:{image:"assets/hering_kartoffeln_auth.webp",price:4.50},knirpsecreme:{image:"assets/kartoffelcreme_auth.webp",price:3.50}};let changed=false;for(const product of PRODUCTS){const patch=patches[product.id];if(!patch)continue;for(const [key,value] of Object.entries(patch)){if(product[key]!==value){product[key]=value;changed=true}}}if(changed)localStorage.setItem("kc_products_v050",JSON.stringify(PRODUCTS));}
...
(function(){
  ...
  function favoritenArtikel(){
    return productsForSale().filter(p=>["grot","gweiss","feuer","sauerkrautmett","gruenkohlmett","knirpse"].includes(p.id)||p.favorite);
  }
